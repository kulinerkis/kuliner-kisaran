<template>
  <div
    class="grid justify-center items-center bg-white rounded-t-[25px] lg:rounded-t-[55px] pb-[164px]"
  >
    <div class="grid justify-center items-center">
      <div class="grid items-center justify-center pt-2 lg:pt-24 lg:pb-7 pb-2">
        <img
          class="lg:w-24 w-20"
      ...
      <h1 class="text-center font-bold lg:text-32 text-20">
        Pendaftaran kamu berhasil!
      </h1>
      <p class="text-center lg:text-24 text-16 pt-2 lg:pb-8 pb-6">
        Terima kasih <span class="font-bold">{{ name }}</span> atas kepercayaan
        kamu
      </p>

      <p
        class="text-12 lg:text-16 lg:pb-6 lg:pt-11 pt-6 pb-4 text-center mx-6 md:w-[658px]"
      >
        Kamu akan segera dihubungi admin Kuliner Kisaran dalam 1 x 24 jam.
      </p>
      <p class="text-12 lg:text-16 text-gray-400 text-center mx-6 md:w-[622px]">
        Atau kamu bisa langsung menghubungi admin Kuliner Kisaran dengan menekan
        tombol di bawah untuk konfirmasi pendaftaran.
      </p>
      <div class="w-full flex justify-center items-center">
        <Button
          class="mt-6 lg:mt-12 w-56 lg:w-72 lg:text-18 text-[14px] lg:py-4 py-3 px-2"
...
export default {
  ...
  methods: {
    clickConfirm() {
      window.open("https://api.whatsapp.com/send?phone=6281269085794");
    },
  },
};
</script>
